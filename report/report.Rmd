...
I tested here `renv` package. I hope that after knitting everything works and the report generates. However, if it does not work, in order to install the package please use the following command:
...
options(renv.auth.MyPackage = list(GITHUB_PAT = "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"))
renv::restore()
